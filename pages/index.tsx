...
const Home: NextPage = () => {
    ...
    return (
        <>
            <section
                id="home"
                className="relative py-20 md:py-32 text-center px-4 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-indigo-900 dark:to-purple-900 overflow-hidden"
            >
                ...
                <div
                    className="absolute bottom-0 right-1/4 w-96 h-96 bg-gradient-to-r from-purple-400/25 to-pink-500/25 rounded-full blur-3xl animate-pulse"
                    style={{ animationDelay: '2s' }}
                ></div>
                <div
                    className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-gradient-to-r from-blue-400/15 to-indigo-500/15 rounded-full blur-3xl animate-pulse"
                ...
                <div className="relative max-w-6xl mx-auto">
                    ...
                    <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold mb-8 md:mb-10 leading-[1.1] tracking-tight">
                        ...
                        <br className="hidden sm:block" />
                        <span className="block mt-4 text-3xl sm:text-4xl md:text-6xl font-bold bg-gradient-to-r from-gray-700 via-gray-800 to-gray-900 dark:from-gray-300 dark:via-gray-200 dark:to-white bg-clip-text text-transparent">
                            {t('hero.title.part3')}
                        </span>
                    </h1>
                        ...
                        <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-8 text-gray-600 dark:text-gray-300">
                            <div className="flex items-center space-x-2 group cursor-pointer hover:scale-105 transition-all duration-300">
                                <div className="flex -space-x-2">
                                    ...
                                    <div
                                        className="w-8 h-8 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full border-2 border-white hover:scale-110 transition-transform duration-300"
                                        style={{ transitionDelay: '50ms' }}
                                    ></div>
                                    <div
                                        className="w-8 h-8 bg-gradient-to-r from-pink-500 to-red-500 rounded-full border-2 border-white hover:scale-110 transition-transform duration-300"
                                        style={{ transitionDelay: '100ms' }}
                                    ></div>
                                    <div
                                        className="w-8 h-8 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full border-2 border-white flex items-center justify-center text-white text-xs font-bold hover:scale-110 transition-transform duration-300"
                                ...
                                <span className="text-sm font-medium group-hover:text-indigo-600 transition-colors duration-300">
                                    {t('hero.socialProof.betaTesters')}
                                </span>
                            </div>
                            <div className="flex items-center space-x-2 group cursor-pointer hover:scale-105 transition-all duration-300">
                                <svg
                                    className="w-5 h-5 text-yellow-500 group-hover:text-yellow-400 group-hover:rotate-12 transition-all duration-300"
                                    fill="currentColor"
                                    viewBox="0 0 20 20"
                                >
            ...
            <section
                id="how-it-works"
                className="py-20 md:py-32 bg-gradient-to-br from-white to-gray-50 dark:from-gray-900 dark:to-gray-800"
            >
                <div className="container mx-auto px-4 md:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-center mb-6 bg-gradient-to-r from-gray-900 via-indigo-900 to-purple-900 dark:from-white dark:via-indigo-200 dark:to-purple-200 bg-clip-text text-transparent tracking-tight">
                            {t('howItWorks.title')}
                        </h2>
                    ...
                    <div className="grid gap-8 md:gap-10 sm:grid-cols-2 lg:grid-cols-4">
                        <div className="bg-white dark:bg-gray-800 p-8 md:p-10 rounded-2xl shadow-xl border border-indigo-100/50 dark:border-gray-700/50 hover:shadow-2xl hover:border-indigo-200 dark:hover:border-indigo-400 transition-all duration-300 hover:-translate-y-2 group cursor-pointer">
                            ...
                            <h3 className="text-xl md:text-2xl font-bold mb-4 text-gray-900 dark:text-white leading-tight group-hover:text-indigo-700 dark:group-hover:text-indigo-400 transition-colors duration-300">
            ...
            <section
                id="pricing"
                className="py-20 md:py-32 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-gray-800 dark:via-indigo-900 dark:to-purple-900"
            >
                <div className="container mx-auto px-4 md:px-8 text-center">
                    ...
                    <div className="grid gap-8 md:gap-10 sm:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
                        <div className="bg-white dark:bg-gray-800 p-10 md:p-12 rounded-3xl shadow-2xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-3xl transition-all duration-500 hover:-translate-y-2 group relative overflow-hidden cursor-pointer">
                            ...
                            <div className="relative">
                                ...
                                <div className="text-3xl md:text-4xl font-bold text-green-600 mb-6 group-hover:text-green-500 transition-colors duration-300">
                                    {t('pricing.features.realTimeRates.title')}
                                </div>
                                <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-lg group-hover:text-gray-700 dark:group-hover:text-gray-200 transition-colors duration-300">
                                    {t(
                                        'pricing.features.realTimeRates.description'
                                    )}
                                </p>
                                <div className="mt-8 pt-6 border-t border-gray-100 group-hover:border-green-100 transition-colors duration-300">
                                    <div className="flex items-center justify-center text-green-600 font-semibold group-hover:text-green-500 transition-colors duration-300">
                                        ...
                                        {t(
                                            'pricing.features.realTimeRates.badge'
                                        )}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="bg-white dark:bg-gray-800 p-10 md:p-12 rounded-3xl shadow-2xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-3xl transition-all duration-500 hover:-translate-y-2 group relative overflow-hidden lg:scale-105 cursor-pointer">
                            ...
                            <div className="relative">
                                ...
                                <div className="text-3xl md:text-4xl font-bold text-blue-600 mb-6 group-hover:text-blue-500 transition-colors duration-300">
                                    {t('pricing.features.noHiddenFees.title')}
                                </div>
                                <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-lg group-hover:text-gray-700 dark:group-hover:text-gray-200 transition-colors duration-300">
                                    {t(
                                        'pricing.features.noHiddenFees.description'
                                    )}
                                </p>
                                <div className="mt-8 pt-6 border-t border-gray-100 group-hover:border-blue-100 transition-colors duration-300">
                                    <div className="flex items-center justify-center text-blue-600 font-semibold group-hover:text-blue-500 transition-colors duration-300">
                                        ...
                                        {t(
                                            'pricing.features.noHiddenFees.badge'
                                        )}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="bg-white dark:bg-gray-800 p-10 md:p-12 rounded-3xl shadow-2xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-3xl transition-all duration-500 hover:-translate-y-2 group relative overflow-hidden cursor-pointer">
                            ...
                            <div className="relative">
                                ...
                                <div className="text-3xl md:text-4xl font-bold text-purple-600 mb-6 group-hover:text-purple-500 transition-colors duration-300">
                                    {t('pricing.features.lowCommission.title')}
                                </div>
                                <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-lg group-hover:text-gray-700 dark:group-hover:text-gray-200 transition-colors duration-300">
                                    {t(
                                        'pricing.features.lowCommission.description'
                                    )}
                                </p>
                                <div className="mt-8 pt-6 border-t border-gray-100 group-hover:border-purple-100 transition-colors duration-300">
                                    <div className="flex items-center justify-center text-purple-600 font-semibold group-hover:text-purple-500 transition-colors duration-300">
                                        ...
                                        {t(
                                            'pricing.features.lowCommission.badge'
                                        )}
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-4 max-w-4xl mx-auto">
                        <div className="text-center group cursor-pointer hover:scale-105 transition-all duration-300 p-4 rounded-2xl hover:bg-white/50">
                            <div className="text-3xl font-bold text-gray-900 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors duration-300">
                                0.5%
                            </div>
                            <div className="text-gray-600 dark:text-gray-300 group-hover:text-gray-700 dark:group-hover:text-gray-200 transition-colors duration-300">
                                {t('pricing.stats.commission')}
                            </div>
                        </div>
                        <div className="text-center group cursor-pointer hover:scale-105 transition-all duration-300 p-4 rounded-2xl hover:bg-white/50">
                            ...
                            <div className="text-gray-600 dark:text-gray-300 group-hover:text-gray-700 dark:group-hover:text-gray-200 transition-colors duration-300">
                                {t('pricing.stats.transferTime')}
                            </div>
                        </div>
                        <div className="text-center group cursor-pointer hover:scale-105 transition-all duration-300 p-4 rounded-2xl hover:bg-white/50">
                            <div className="text-3xl font-bold text-gray-900 group-hover:text-pink-600 transition-colors duration-300">
                                180+
                            </div>
                            <div className="text-gray-600 dark:text-gray-300 group-hover:text-gray-700 dark:group-hover:text-gray-200 transition-colors duration-300">
                                {t('pricing.stats.countries')}
                            </div>
                        </div>
                        <div className="text-center group cursor-pointer hover:scale-105 transition-all duration-300 p-4 rounded-2xl hover:bg-white/50">
            ...
            <section
                id="about-us"
                className="py-20 md:py-32 bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 dark:from-gray-800 dark:via-blue-900 dark:to-indigo-900"
            >
                <div className="container mx-auto px-4 md:px-8 text-center">
                    <div className="mb-16">
                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-6 bg-gradient-to-r from-gray-900 via-indigo-900 to-purple-900 dark:from-white dark:via-indigo-200 dark:to-purple-200 bg-clip-text text-transparent tracking-tight">
                    ...
                    <div className="grid gap-10 md:gap-12 sm:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
                        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-10 md:p-12 rounded-3xl shadow-2xl border border-white/50 dark:border-gray-700/50 hover:shadow-3xl transition-all duration-500 hover:-translate-y-3 group relative overflow-hidden cursor-pointer">
                            ...
                            <div className="relative">
                                ...
                                <h3 className="text-2xl md:text-3xl font-bold mb-6 text-gray-900 dark:text-white group-hover:text-purple-700 dark:group-hover:text-purple-400 transition-colors duration-300">
                                    {t('aboutUs.features.web3Simplified.title')}
                                </h3>
                                <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-lg mb-6 group-hover:text-gray-700 dark:group-hover:text-gray-200 transition-colors duration-300">
                                    {t(
                                        'aboutUs.features.web3Simplified.description'
                                    )}
                                </p>
                                <div className="flex items-center justify-center">
                                    <div className="px-4 py-2 bg-gradient-to-r from-purple-100 to-blue-100 rounded-full group-hover:from-purple-200 group-hover:to-blue-200 transition-all duration-300 group-hover:scale-105">
                                        <span className="text-purple-700 font-semibold text-sm">
                                            {t(
                                                'aboutUs.features.web3Simplified.badge'
                                            )}
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-10 md:p-12 pt-16 md:pt-18 rounded-3xl shadow-2xl border border-white/50 dark:border-gray-700/50 hover:shadow-3xl transition-all duration-500 hover:-translate-y-3 group relative overflow-hidden lg:scale-105 cursor-pointer">
                            ...
                            <div className="relative">
                                ...
                                <h3 className="text-2xl md:text-3xl font-bold mb-6 text-gray-900 dark:text-white group-hover:text-green-700 dark:group-hover:text-green-400 transition-colors duration-300">
                                    {t('aboutUs.features.forRealPeople.title')}
                                </h3>
                                <p className="text-gray-800 dark:text-gray-300 leading-relaxed text-lg mb-6 group-hover:text-gray-900 dark:group-hover:text-gray-200 transition-colors duration-300">
                                    {t(
                                        'aboutUs.features.forRealPeople.description'
                                    )}
                                </p>
                                <div className="flex items-center justify-center">
                                    <div className="px-4 py-2 bg-gradient-to-r from-green-100 to-teal-100 rounded-full group-hover:from-green-200 group-hover:to-teal-200 transition-all duration-300 group-hover:scale-105">
                                        <span className="text-green-700 font-semibold text-sm">
                                            {t(
                                                'aboutUs.features.forRealPeople.badge'
                                            )}
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-10 md:p-12 rounded-3xl shadow-2xl border border-white/50 dark:border-gray-700/50 hover:shadow-3xl transition-all duration-500 hover:-translate-y-3 group relative overflow-hidden cursor-pointer">
                            ...
                            <div className="relative">
                                ...
                                <h3 className="text-2xl md:text-3xl font-bold mb-6 text-gray-900 dark:text-white group-hover:text-orange-700 dark:group-hover:text-orange-400 transition-colors duration-300">
                                    {t(
                                        'aboutUs.features.invisibleInnovation.title'
                                    )}
                                </h3>
                                <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-lg mb-6 group-hover:text-gray-700 dark:group-hover:text-gray-200 transition-colors duration-300">
                                    {t(
                                        'aboutUs.features.invisibleInnovation.description'
                                    )}
                                </p>
                                <div className="flex items-center justify-center">
                                    <div className="px-4 py-2 bg-gradient-to-r from-orange-100 to-red-100 rounded-full group-hover:from-orange-200 group-hover:to-red-200 transition-all duration-300 group-hover:scale-105">
                                        <span className="text-orange-700 font-semibold text-sm">
                                            {t(
                                                'aboutUs.features.invisibleInnovation.badge'
                                            )}
                                        </span>
                                    </div>
                                </div>
            ...
            <section
                id="waitlist"
                className="py-20 md:py-32 bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 text-white relative overflow-hidden"
            >
                ...
                <div
                    className="absolute bottom-0 left-1/4 w-96 h-96 bg-gradient-to-r from-indigo-400/40 to-purple-500/40 rounded-full blur-3xl animate-pulse"
                    style={{ animationDelay: '3s' }}
                ></div>
                <div
                    className="absolute top-1/2 right-1/3 w-64 h-64 bg-gradient-to-r from-pink-400/30 to-red-500/30 rounded-full blur-3xl animate-pulse"
                ...
                <div className="relative container mx-auto px-4 md:px-8 text-center">
                    ...
                    <div className="grid gap-6 sm:grid-cols-3 max-w-3xl mx-auto text-base text-white/80">
                        <div className="flex items-center justify-center space-x-3 bg-white/15 backdrop-blur-md p-4 rounded-2xl border border-white/25 hover:bg-white/20 transition-all duration-300 hover:scale-105 cursor-pointer group">
                            <svg
                                className="w-5 h-5 text-green-400 flex-shrink-0 group-hover:scale-110 group-hover:rotate-12 transition-all duration-300"
                                fill="currentColor"
                                viewBox="0 0 20 20"
                            >
                                <path
                            ...
                            <span className="font-medium text-white group-hover:text-green-200 transition-colors duration-300">
                                {t('waitlist.benefits.earlyAccess')}
                            </span>
                        </div>
                        <div className="flex items-center justify-center space-x-3 bg-white/15 backdrop-blur-md p-4 rounded-2xl border border-white/25 hover:bg-white/20 transition-all duration-300 hover:scale-105 cursor-pointer group">
                            <svg
                            ...
                            <span className="font-medium text-white group-hover:text-green-200 transition-colors duration-300">
                                {t('waitlist.benefits.launchBonuses')}
                            </span>
                        </div>
                        <div className="flex items-center justify-center space-x-3 bg-white/15 backdrop-blur-md p-4 rounded-2xl border border-white/25 hover:bg-white/20 transition-all duration-300 hover:scale-105 cursor-pointer group">
                            <svg
