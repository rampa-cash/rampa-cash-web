            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        >
                            {isRefreshing
                                ? t('dashboard.balance.refreshing')
                                : t('dashboard.balance.refresh')}
                        </button>
                    </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                    ...
                    >
                        ...
                        <p className="text-sm font-medium text-gray-900">
                            {t('dashboard.actions.receiveMoney')}
                        </p>
                    </button>
                            ...
                            <div className="flex justify-between items-center">
                                <div>
                                    <p className="text-sm opacity-90 mb-1">
                                        {t('dashboard.visaCard.cardNumber')}
                                    </p>
                                    <p className="text-xl font-mono">
                                        •••• •••• ••••{' '}
                                        {mockWallet.visaCard.lastFour}
                                    </p>
                                </div>
                                <div className="text-right">
                                    <p className="text-sm opacity-90 mb-1">
                                        {t('dashboard.visaCard.status')}
                                    </p>
                                    <p className="text-sm font-medium capitalize">
                                        {mockWallet.visaCard.status}
                                    </p>
                                </div>
                            </div>
                        </div>
