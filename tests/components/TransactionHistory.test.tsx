...
describe('TransactionHistory', () => {
    ...
    it('should show loading state when transactions are loading', () => {
        const mockUseTransactions = require('@/hooks/useTransactions').useTransactions
    ...
    it('should load more transactions when load more button is clicked', () => {
        ...
        mockUseTransactions.mockReturnValue({
            transactions: [
                { id: '1', type: 'send', amount: 100, currency: 'USD', recipient: 'Jane Smith', status: 'completed', timestamp: '2024-01-15T10:30:00Z' },
            ],
            isLoading: false,
            error: null,
            hasMore: true,
    ...
    it('should show transaction details when transaction is clicked', () => {
        ...
        const transactionItem = screen.getByText(/jane smith/i).closest('[data-testid="transaction-item"]')
