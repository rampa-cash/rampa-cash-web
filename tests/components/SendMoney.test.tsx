...
describe('SendMoney', () => {
    ...
    it('should render recipient type selection', () => {
        ...
        expect(screen.getByRole('radio', { name: /wallet address/i })).toBeInTheDocument()
    })
    ...
    it('should show validation error for invalid email format', async () => {
        ...
        fireEvent.change(recipientInput, { target: { value: 'invalid-email' } })
    ...
    it('should validate recipient before sending', async () => {
        ...
        await waitFor(() => {
            expect(mockValidateRecipient).toHaveBeenCalledWith('unknown@example.com', 'email')
