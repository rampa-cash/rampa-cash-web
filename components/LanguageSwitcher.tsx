                        ...
                        <div className="py-2">
                            {languages.map(language => (
                                <button
                                    ...
                                    className={`flex items-center space-x-3 w-full px-4 py-3 text-left hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 dark:hover:from-indigo-900/50 dark:hover:to-purple-900/50 transition-all duration-200 group ${
                                        router.locale === language.code
                                            ? 'bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/50 dark:to-purple-900/50'
                                            : ''
                                    }`}
                                >
