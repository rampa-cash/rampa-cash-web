...
export default function SecuritySection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-gradient-to-r from-purple-400/10 to-pink-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="container mx-auto px-4 md:px-8 relative">
        ...
        <div className="grid gap-6 md:gap-8 sm:grid-cols-2 lg:grid-cols-3 max-w-7xl mx-auto mb-16">
          {/* Self Custody */}
          <div className="bg-white dark:bg-gray-800 p-6 md:p-8 rounded-2xl shadow-xl border border-indigo-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 group cursor-pointer animate-fade-in-up" style={{ animationDelay: '0ms' }}>
          ...
          {/* No Seed Phrase */}
          <div className="bg-white dark:bg-gray-800 p-6 md:p-8 rounded-2xl shadow-xl border border-indigo-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 group cursor-pointer animate-fade-in-up" style={{ animationDelay: '100ms' }}>
          ...
          {/* Only You */}
          <div className="bg-white dark:bg-gray-800 p-6 md:p-8 rounded-2xl shadow-xl border border-indigo-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 group cursor-pointer animate-fade-in-up" style={{ animationDelay: '200ms' }}>
          ...
          {/* Easy Recovery */}
          <div className="bg-white dark:bg-gray-800 p-6 md:p-8 rounded-2xl shadow-xl border border-indigo-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 group cursor-pointer animate-fade-in-up" style={{ animationDelay: '300ms' }}>
          ...
          {/* Always On */}
          <div className="bg-white dark:bg-gray-800 p-6 md:p-8 rounded-2xl shadow-xl border border-indigo-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 group cursor-pointer animate-fade-in-up" style={{ animationDelay: '400ms' }}>
          ...
          {/* Private by Default */}
          <div className="bg-white dark:bg-gray-800 p-6 md:p-8 rounded-2xl shadow-xl border border-indigo-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 group cursor-pointer animate-fade-in-up" style={{ animationDelay: '500ms' }}>
            ...
            <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
              {t('security.features.privateByDefault.description')}
            </p>
          </div>
        </div>
