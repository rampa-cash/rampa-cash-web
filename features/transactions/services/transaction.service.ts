...
export class TransactionService {
    ...
    static async getTransactionDetails(
        ...
        try {
            ...
            const response = await TransactionApiClient.getTransaction(
                transactionId,
                token
            );
            ...
            return {
                ...
                solanaTransactionHash:
                    response.solanaTransactionHash || undefined,
    ...
    static async getSentTransactions(
        ...
        try {
            ...
            const response = await TransactionApiClient.getSentTransactions(
                limit,
                offset,
                token
            );
    ...
    static async getReceivedTransactions(
        ...
        try {
            ...
            const response = await TransactionApiClient.getReceivedTransactions(
                limit,
                offset,
                token
            );
    ...
    static async getPendingTransactions(
        ...
        try {
            ...
            const response =
                await TransactionApiClient.getPendingTransactions(token);
    ...
    static async getTransactionStats(
        ...
        try {
            ...
            return await TransactionApiClient.getTransactionStats(
                startDate,
                endDate,
                token
            );
    ...
    static async confirmTransaction(
        ...
        try {
            ...
            await TransactionApiClient.confirmTransaction(
                transactionId,
                solanaTransactionHash,
                token
            );
