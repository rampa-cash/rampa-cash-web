                    ...
                    {isLoading ? (
                        ...
                        <div className="space-y-3">
                            {entries.map((entry: InquiryResponse, index) => (
                                <div
                                    key={entry.id}
                                    className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-300 dark:border-gray-600 shadow-md hover:shadow-lg transition-shadow duration-200"
                                >
